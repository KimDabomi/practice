...
- ReactChartjs2라는 Wrapper 라이브러리를 통해 React에서 사용가능
- https://react-chartjs-2.js.org/
- yarn add chart.js react-chartjs-2


Lodash
- 배열, JSON 등의 연속성 자료형에 대한 탐색 및 깊은 복사 등의 기능을 제공
- https://lodash.com/
- yarn add lodash
- 참고페이지 : https://velog.io/@kysung95/짤막글-lodash-알고-쓰자
*/
...
import {
  // 공통 항목
  Chart,CategoryScale,LinearScale,Title,Tooltip,Legend,
  // 세로, 가로 막대 그래프 전용
  BarElement,
  // 선 그래프 및 산점도 그래프 전용
...
const ChartEx = memo(() => {
  ...
  const covid19 = {
    ...
    datasets: [{
      label: '서울시 확진자',
      data: [1237,118,719,2042,1775,1580,1605],
      backgroundColor: 'rgba(255,99,132,0.5)',
      borderColor: 'rgba(255,99,132,1)',
      borderWidth: 1
    },{
